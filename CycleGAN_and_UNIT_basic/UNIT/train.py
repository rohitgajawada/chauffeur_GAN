...
parser.add_argument('--config', type=str, default='configs/epic2real-stquirze-10JUL.yaml', help='Path to the config file.')
parser.add_argument('--output_path', type=str, default='/datatmp/Experiments/unitgan_rohitrishabh', help="outputs path")
