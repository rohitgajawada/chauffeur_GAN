...
import network.models.coil_ganmodules_nopatch_morelayers as ganmodels_nopatch_morelayers
...
def execute(gpu, exp_batch, exp_alias):
    ...
    if g_conf.GANMODEL_NAME == 'LSDcontrol':
        ...
        netG = ganmodels_nopatch._netG(skip=g_conf.SKIP).cuda()
    elif g_conf.GANMODEL_NAME == 'LSDcontrol_nopatch_morelayers':
        netD = ganmodels_nopatch_morelayers._netD().cuda()
        netG = ganmodels_nopatch_morelayers._netG(skip=g_conf.SKIP).cuda()
