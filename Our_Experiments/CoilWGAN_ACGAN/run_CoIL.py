...
from coil_core import execute_train, execute_validation, execute_drive, folder_execute, testGAN, trainnoGAN, trainnewGAN, trainnewGAN_task, trainWGAN_task, trainWGAN_task_backup
...
if __name__ == '__main__':
    ...
    if args.single_process is not None:
        if args.single_process == 'train':
            ...
            trainWGAN_task_backup.execute("9", "eccv", "aug")
