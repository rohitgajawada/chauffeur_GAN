...
def create_log(exp_batch_name, exp_name, process_name, log_frequency=1):
    ...
    root_path = "/datatmp/Experiments/rohitgan/_logs"
...
def add_image(tag, images, iteration=None):
    ...
    # if iteration is not None:
    # if iteration % LOG_FREQUENCY == 0:
    # imgs_1 = images.view(-1, 3, 88, 200)
    imgs_1 = images.cpu().data
    imgs_1 = imgs_1
    images_1 = imgs_1 * 255.0
    images_1 = images_1.clamp(0.0, 255.0)
    # print("REALLLL")
    # print(images_1[0])
    # # print(images_1[0])
    # print("FAKKKEEEE")
    ...
    images_1 = np.uint8(images_1)
    tl.image_summary(tag, images_1, iteration + 1)
    # else:
    #     images = images.view(-1, 3, 88, 200).cpu().data.numpy()
