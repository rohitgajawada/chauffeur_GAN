...
if __name__ == '__main__':
    ...
    if args.single_process is not None:
        if args.single_process == 'train':
            ...
            # train_da_shared.execute("7", "eccv", "all_da_shared_E1E12_l1_25_new_nopretrained")
            # train_da_shared.execute("8", "eccv", "all_da_shared_E1E12_l1_25_new_nopretrained_aug")
            train_da_shared.execute("9", "eccv", "all_da_shared_E1E12_l1_25_new_nopretrained_highadv")
