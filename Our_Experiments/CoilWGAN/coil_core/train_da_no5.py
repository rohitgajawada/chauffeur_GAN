...
def execute(gpu, exp_batch, exp_alias):
    ...
    real_dataset = '/datatmp/Datasets/UNIT_LW1toEW12/trainB'
    ...
    if g_conf.GANMODEL_NAME == 'LSDcontrol':
        ...
        if g_conf.PRETRAINED == 'IL':
            ...
            if g_conf.IF_AUG:
                ...
                model_dec = torch.load('Decoder_Recon_Aug.pth')
            else:
    ...
    for data in data_loader:
        ...
        try:
            ...
            coil_logger.add_scalar('Adv Bin LossG', lossG_adv_bin, iteration)
