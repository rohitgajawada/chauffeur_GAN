...
class CoILDataset(Dataset):
    ...
    def __init__(self, root_dir, transform=None):# The transformation object.
        ...
        self.NUMBER_FRAMES_FUSION = 1
        self.SENSORS = {'rgb': (3, 88, 200)}
        self.MEASUREMENTS = {'targets': (31)}
    ...
    def __getitem__(self, used_ids):
        ...
        for sensor_name, sensor_size in self.SENSORS.items():
            sensor_data = np.zeros(
                (number_of_position, sensor_size[0], sensor_size[1],
                 sensor_size[2] * self.NUMBER_FRAMES_FUSION),
                 dtype='float32'
            )
        ...
        for sensor_name, sensor_size in self.SENSORS.items():
            ...
            for chosen_key in used_ids:
                ...
                for i in range(self.NUMBER_FRAMES_FUSION):
    ...
    def pre_load_hdf5_files(self, path_for_files):
        ...
        meas_names = list(self.MEASUREMENTS.keys())
        # take the names for all sensors
        sensors_names = list(self.SENSORS.keys())
