...
_g_conf.NUMBER_ITERATIONS = 60000000
_g_conf.SAVE_SCHEDULE = range(0, 60000000, 1000)
_g_conf.NUMBER_FRAMES_FUSION = 1
_g_conf.NUMBER_IMAGES_SEQUENCE = 1
_g_conf.SEQUENCE_STRIDE = 1
_g_conf.TEST_SCHEDULE = range(0, 60000000, 1000)
_g_conf.SPEED_FACTOR = 40.0
_g_conf.AUGMENT_LATERAL_STEERINGS = 6

#finetuning options
_g_conf.FINETUNE = True
_g_conf.TYPE = "complete"
_g_conf.MODEL_PATH = "./66000.pth"
...
_g_conf.MIN_LEARNING_RATE = 0.000002
...
_g_conf.IMAGE_CUT = [300, 600]  # How you should cut the input image that is received from the server
