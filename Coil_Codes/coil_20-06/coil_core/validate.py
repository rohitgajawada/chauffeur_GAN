...
def execute(gpu, exp_batch, exp_alias, dataset_name):
    ...
    print (dataset.meta_data[0][0])
    cpts = glob.glob('/home-local/rohitrishabh/coil_20-06/_logs/eccv/experiment_1/checkpoints/*.pth')
    ...
    for ckpt in cpts:
        ...
        for data in data_loader:
            ...
            coil_logger.add_message('Iterating in Validation',
                    {'Checkpoint': latest,
        ...
        print('Loss: ', checkpoint_average_loss, "----Error: ", checkpoint_average_error)
