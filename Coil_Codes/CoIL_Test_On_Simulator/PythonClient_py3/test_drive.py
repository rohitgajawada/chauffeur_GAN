...
def execute(gpu, exp_batch, exp_alias, ckpt, model, city_name='Town01', memory_use=0.2, host='127.0.0.1'):
...
argparser.add_argument(
    ...
    '--checkpoint',
    type=str,
    help='Checkpoint file for test drive')
argparser.add_argument(
    '-m',
    '--model',
    type=str,
...
execute("0", "eccv", "experiment_1", args.checkpoint, args.model, 'SantQuirze')
