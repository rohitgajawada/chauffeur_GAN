...
from coil_core import execute_train, execute_validation, execute_drive, folder_execute, testGAN, trainnoGAN, trainnewGAN, trainnewGAN_task, trainWGAN_task, train_da
...
if __name__ == '__main__':
    ...
    if args.single_process is not None:
        if args.single_process == 'train':
            ...
            train_da.execute("5", "eccv", "all_da_aug")
